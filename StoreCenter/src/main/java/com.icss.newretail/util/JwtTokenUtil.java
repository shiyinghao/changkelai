...
public class JwtTokenUtil {
	...
	public static String currUser() {
		return currUserInfo().get("userId").toString();
	}

	public static String sessionKey() {
		return currUserInfo().get("openId").toString();
	}
...
//
	 ...
	 * @return
	 */
	public static List<OrgList> currOrg() {
		List<OrgList> list = (List) currUserInfo().get("org");
		return list;
	}
	 ...
	 * @return
	 */
	public static Map<String, Object> currUserInfo() {
		...
		if (StringUtils.isNotBlank(subject)) {
			HashMap hashMap = JSON.parseObject(subject, HashMap.class);
			return hashMap;
		} else {
