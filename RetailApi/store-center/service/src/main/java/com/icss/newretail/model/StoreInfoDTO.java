...
public class StoreInfoDTO implements Serializable {
	...
	@ApiModelProperty(value = "上级组织机构编码")
    ...
    private String openEnTime;

	@ApiModelProperty(value = "卡券数量")
	private Integer couponQuantity =0;

	@ApiModelProperty(value = "卡券总量")
	private Integer couponSumQuantity =0;

	@ApiModelProperty(value = "卡券数量")
	private Integer couponQuantityOld =0;

	@ApiModelProperty(value = "卡券总量")
	private Integer couponSumQuantityOld =0;
