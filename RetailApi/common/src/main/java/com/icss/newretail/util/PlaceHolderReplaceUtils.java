...
public class PlaceHolderReplaceUtils {
     ...
     * @return
     */
    public String replaceWithMap(String sourceString, Map<String, Object> param) {
     ...
     * @return
     */
    public String replaceWithObject(String sourceString, Object param) {
     ...
     * @return
     */
    public Set<String> findPlaceHolderKeys(String sourceString, Pattern pattern) {
